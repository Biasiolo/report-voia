...
export default function SelectPlatforms() {
    ...
    return (
        <div className="min-h-screen bg-black px-4 py-12">
            <div className="max-w-5xl mx-auto bg-zinc-100 rounded-3xl shadow-xl p-8">
                    ...
                    {platforms.map((platform) => {
                        ...
                        return (
                            <button
                                ...
                                className={`
                  relative overflow-hidden group rounded-3xl p-6 text-left cursor-pointer
                  transition-all duration-300 ease-in-out
                  ${isSelected
                                        ? 'bg-gradient-to-r from-zinc-100 via-stone-100 to-gray-200 shadow-md shadow-stone-300'
                                        : 'bg-neutral-50 shadow-md hover:shadow-md shadow-stone-500'
                                    }
                `}
                            >
                                {isSelected && (
                  ...
                  ${isSelected ? 'bg-gradient-to-b from-orange-600 via-teal-500 to-purple-500' : 'bg-transparent'}
                ...
                `}></div>
                    ...
                    ${isSelected
                                            ...
                                            : 'bg-gradient-to-br from-teal-200 via-gray-100 to-purple-200 text-teal-600 group-hover:bg-teal-50'
                                        } 
              ...
              ${selected.length === 0
                                ...
                                : 'bg-teal-500 hover:bg-teal-400 hover:text-teal-800 cursor-pointer'
                            }
            `}
                    >
                        {selected.length === 0 ? (
